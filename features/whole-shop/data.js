...
'Chicken wraps':{emoji:'🌯',category:'lunch',servings:2,ingredients:[{name:'Wraps',quantity:2,unit:'items'},{name:'Chicken breast',quantity:200,unit:'g'},{name:'Lettuce',quantity:.25,unit:'head'},{name:'Mayonnaise',quantity:30,unit:'g'}]},
...
{id:'snacks',label:'Snacks & fruit',icon:'nutrition-outline',examples:['Apples','Bananas','Crisps','Yoghurts']},
{id:'drinks',label:'Drinks',icon:'cafe-outline',examples:['Milk','Coffee','Tea','Squash']},
{id:'home',label:'Home & cleaning',icon:'home-outline',examples:['Washing liquid','Dishwasher tablets','Bin bags','Kitchen roll']},
{id:'care',label:'Toiletries',icon:'water-outline',examples:['Toilet roll','Toothpaste','Shampoo','Deodorant']},
{id:'baby',label:'Baby',icon:'happy-outline',examples:['Nappies','Baby wipes','Formula']},
{id:'pets',label:'Pets',icon:'paw-outline',examples:['Cat food','Dog food','Cat litter']}
];
export const RETAILERS=[
{name:'Tesco',url:'https://www.tesco.com/groceries/'},{name:'Sainsbury’s',url:'https://www.sainsburys.co.uk/gol-ui/groceries'},{name:'Asda',url:'https://www.asda.com/'},{name:'Morrisons',url:'https://groceries.morrisons.com/'},{name:'Waitrose',url:'https://www.waitrose.com/ecom/shop/browse/groceries'},{name:'Ocado',url:'https://www.ocado.com/'},{name:'Iceland',url:'https://www.iceland.co.uk/'},{name:'Co-op',url:'https://shop.coop.co.uk/'}
];
